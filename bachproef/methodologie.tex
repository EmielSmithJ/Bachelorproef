...
\textbf{Deliverables Sprint 3:} (a) gecontroleerde validatiescenario's, (b) technische bewijsstukken zoals testoutput, screenshots en packet captures, (c) samenvatting van bevindingen per risico/hypothese.
...
\section{\IfLanguageName{dutch}{Sprint 5: Eindrapport en Documentatie}{Sprint 5: Final report and Documentation}}%
\label{sec:meth-sprint5}

In Sprint 5 worden context, methode, resultaten en aanbevelingen samengebracht
in een eindrapport dat traceerbaar is: elke aanbeveling verwijst naar een vastgesteld
risico en de onderliggende observaties of testresultaten. De nadruk ligt op het
samenbrengen van de onderzoeksresultaten, het structureren van de bewijsvoering
en het formuleren van praktisch uitvoerbare aanbevelingen voor de onderzochte
omgeving.

Daarnaast worden de relevante bijlagen en technische artefacten geordend, zodat
de gevolgde aanpak, de gebruikte testresultaten en de onderliggende bewijsstukken
controleerbaar blijven.

\textbf{Deliverables Sprint 5:} (a) eindrapport, (b) bijlagen met artefacten
(topologie, testplan, logs/PoC's waar toegestaan), (c) finale synthese van de
aanbevelingen.